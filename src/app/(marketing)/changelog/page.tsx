...
export default async function ChangelogPage() {
  ...
  return (
    <Container className="py-12">
      <h1 className="text-3xl font-semibold tracking-tight">Changelog (Mock)</h1>
      ...
      <div className="mt-10 space-y-8">
        {items.map((it) => (
          <div key={it.id} className="rounded-2xl border border-black/10 p-6 dark:border-white/10">
